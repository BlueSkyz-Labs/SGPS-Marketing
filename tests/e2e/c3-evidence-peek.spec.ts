...
test.describe("C3-B evidence peek", () => {
  ...
  test.afterAll(async () => closeServer());
    ...
    try {
      ...
      const peek = page.locator('[data-product-proof-capability="Fixture capability one"]');
  ...
  test("keyboard and 320px mobile preserve native disclosure and 44px summary", async ({ page }) => {
